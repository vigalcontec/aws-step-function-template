...
# =============================================================================
# Export Step Function information to SSM Parameter Store.
# Other projects can read these parameters to integrate with this Step Function.

# ─────────────────────────────────────────────────────────────────────────────
# Step Function ARN
# ─────────────────────────────────────────────────────────────────────────────
resource "aws_ssm_parameter" "state_machine_arn" {
  name        = "/${var.environment}/stepfunction/${local.project_name}/state_machine_arn"
...
resource "aws_ssm_parameter" "state_machine_name" {
  name        = "/${var.environment}/stepfunction/${local.project_name}/state_machine_name"
...
resource "aws_ssm_parameter" "role_arn" {
  name        = "/${var.environment}/stepfunction/${local.project_name}/role_arn"
