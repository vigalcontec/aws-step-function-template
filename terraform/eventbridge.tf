# =============================================================================
# EventBridge - S3 Event Trigger (Optional)
# =============================================================================
# Triggers the Step Function when objects are created in S3.
# Enable/disable in config.tf: local.s3_trigger.enabled

# -----------------------------------------------------------------------------
# S3 Bucket Data Source (for trigger)
# -----------------------------------------------------------------------------
# Uncomment and modify if using S3 trigger with datalake bucket
...
#   description = "Trigger Step Function when object is created in S3"
#
