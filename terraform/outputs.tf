...
# SSM Parameters
# -----------------------------------------------------------------------------
output "ssm_state_machine_arn" {
  description = "SSM parameter path for state machine ARN"
  value       = aws_ssm_parameter.state_machine_arn.name
}

output "ssm_state_machine_name" {
  description = "SSM parameter path for state machine name"
  value       = aws_ssm_parameter.state_machine_name.name
}

# -----------------------------------------------------------------------------
# EventBridge (uncomment if using S3 trigger)
# -----------------------------------------------------------------------------
